...
const Footer = () => {
  return (
    <div className='bg-black w-full mx-auto p-[7rem] text-white'>
        <div className="grid grid-cols-4 gap-5">
  <div className="sc-bWJUgm deWTKQ">
    <div className="flex items-center gap-4 p-2">
      <span className="sc-lfYzqA cLqZlX">
        <svg
          width={21}
          height={32}
          viewBox="0 0 21 32"
      ...
      <div className="text-lg font-bold">Swiggy</div>
    </div>
    <div className="text-slate-500 p-2">© 2024 Bundl Technologies Pvt. Ltd</div>
  </div>
  <div className="sc-ijDOKB gKECra">
    <ul className="sc-eBwKMn dANYRo">
      <li className="sc-cKXybt plqkk">
        <div className="sc-aXZVg jimIco font-bold mb-2">Company</div>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/about">
          <div className="text-slate-500">About</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/careers" >
          <div className="text-slate-500">Careers</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/team" >
      ...
      <li className="sc-bHnlcS jzYwIM">
        ...
        >
          <div className="text-slate-500">Swiggy One</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
        ...
        >
          <div className="text-slate-500">Swiggy Instamart</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
        ...
        >
          <div className="text-slate-500">Swiggy Genie</div>
        </a>
      </li>
    </ul>
  </div>
    ...
    <ul className="sc-eBwKMn dANYRo">
      ...
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/support">
          <div className="text-slate-500">Help &amp; Support</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
        ...
        >
          <div className="text-slate-500">Partner with us</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
        ...
        >
          <div className="text-slate-500">Ride with us</div>
        </a>
      </li>
    </ul>
  </div>
  <div className="sc-ijDOKB gKECra">
    <ul className="sc-eBwKMn dANYRo">
      ...
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/cookie-policy">
          <div className="text-slate-500">Cookie Policy</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/privacy-policy" rel="">
          <div className="text-slate-500">Privacy Policy</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
          ...
          rel=""
        >
          <div className="text-slate-500">Investor Relations</div>
        </a>
      </li>
    </ul>
  </div>
  ...
  <div className="sc-ijDOKB gKECra">
    <ul className="sc-eBwKMn dANYRo">
      <li className="sc-cKXybt plqkk">
        <div className="font-bold mb-2">We deliver to:</div>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
          href="https://www.swiggy.com/city/bangalore"
          className="sc-djTQaJ ksrOfQ"
        >
          <div className="text-slate-500">Bangalore</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
          ...
          className="sc-djTQaJ ksrOfQ"
        >
          <div className="text-slate-500">Gurgaon</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
          ...
          className="sc-djTQaJ ksrOfQ"
        >
          <div className="text-slate-500">Hyderabad</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
          ...
          className="sc-djTQaJ ksrOfQ"
        >
          <div className="text-slate-500">Delhi</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <a
      ...
      <li className="sc-bHnlcS jzYwIM">
        <a href="https://www.swiggy.com/city/pune" className="sc-djTQaJ ksrOfQ">
          <div className="text-slate-500">Pune</div>
        </a>
      </li>
      <li className="sc-bHnlcS jzYwIM">
        <button className="sc-lgjHQU iJTuGh">
          <div className="sc-fatcLD bFrAwI">
            <div className="text-slate-500">589 cities</div>
            <div className="sc-cgjDci kUjJJX">
              <svg
                aria-hidden="true"
                height={12}
                width={12}
                className="sc-dhKdcB iVFUwp"
              >
                <use xlinkHref="/core/sprite-2e61ee4e.svg#chevronDown12" />
              </svg>
            </div>
          </div>
        </button>
